...
const beatPoliceInfo = [
  ...
  },
  {
    ...
    officers: [
      ...
      {
        name: "Sri Naresh",
        kannadaName: "ಶ್ರೀ ನರೇಶ್",
        designation: "CPC-24",
        kannadaDesignation: "ಸಿಪಿಸಿ-24",
        phone: "8217628684",
      },
    ],
    supervisor: {
  ...
  },
  {
    ...
    officers: [
      ...
      {
        name: "Smt. Prema",
        kannadaName: "ಶ್ರೀಮತಿ ಪ್ರೇಮ",
        designation: "CPC-316",
        kannadaDesignation: "ಸಿಪಿಸಿ-316",
        phone: "9448776989",
      },
    ],
    supervisor: {
  ...
  },
  {
    ...
    officers: [
      ...
      {
        name: "Sri Sampattu",
        kannadaName: "ಶ್ರೀ ಸಂಪತ್ತು",
        designation: "CPC-95",
        kannadaDesignation: "ಸಿ.ಪಿ.ಸಿ 95",
        phone: "9611472946",
      },
    ],
    supervisor: {
  ...
  {
    beatNumber: 28,
    areas: ["Ward No. 28", "Ele Pete", "Korachar Pete", "Bamboo Bazaar", "Private Bus Stand", "Taluk Office"],
    kannadaAreas: ["ವಾರ್ಡ್ ಸಂಖ್ಯೆ 28", "ಎಲೆಪೇಟೆ", "ಕೊರಚರ ಪೇಟೆ", "ಬಂಬೂ ಬಜಾರ್", "ಖಾಸಗಿ ಬಸ್ ನಿಲ್ದಾಣ", "ತಾಲ್ಲೂಕು ಕಛೇರಿ"],
    officers: [
      {
        name: "Sri Khalandar",
        kannadaName: "ಶ್ರೀ ಖಲಂದರ್",
        designation: "CHC-209",
        kannadaDesignation: "ಸಿ.ಹೆಚ್.ಸಿ-209",
        phone: "9740190901",
      },
    ],
    supervisor: {
      name: "Sri Muralidhara",
      kannadaName: "ಶ್ರೀ ಮುರಳೀಧರ",
      designation: "ASI",
      kannadaDesignation: "ಎ.ಎಸ್.ಐ",
      phone: "9741471828",
    },
  ...
  {
    beatNumber: 29,
    areas: ["Ward No. 29", "Sunnakalu Street", "Devappa Layout", "Chamaraja Pete"],
    kannadaAreas: ["ವಾರ್ಡ್ ಸಂಖ್ಯೆ 29", "ಸುಣ್ಣಕಲ್ಲು ಬೀದಿ", "ದೇವಪ್ಪ ಲೇಔಟ್", "ಚಾಮರಾಜಪೇಟೆ"],
    officers: [
      {
        name: "Sri Manjunatha R.S",
        kannadaName: "ಶ್ರೀ ಮಂಜುನಾಥ ಆರ್.ಎಸ್",
        designation: "CPC-454",
        kannadaDesignation: "ಸಿಪಿಸಿ-454",
        phone: "8747875419",
      },
    ],
    supervisor: {
  ...
  {
    beatNumber: 30,
    areas: ["Ward No. 30", "Ambedkar Nagar", "Sidlaghat Road Right Side"],
    kannadaAreas: ["ವಾರ್ಡ್ ಸಂಖ್ಯೆ 30", "ಅಂಬೇಡ್ಕರ್ ನಗರ", "ಶಿಡ್ಲಘಟ್ ರಸ್ತೆ ಬಲಭಾಗ"],
    officers: [
      {
        name: "Sri Harish H.V",
        kannadaName: "ಶ್ರೀ ಹರೀಶ್ ಹೆಚ್.ವಿ",
        designation: "HC-141",
        kannadaDesignation: "ಹೆಚ್.ಸಿ-141",
        phone: "7411134305",
      },
    ],
    supervisor: {
  ...
  {
    beatNumber: 31,
    areas: ["Ward No. 31", "Indra Nagar", "T.B. Vanke", "Manchanabale Road"],
    kannadaAreas: ["ವಾರ್ಡ್ ಸಂಖ್ಯೆ 31", "ಇಂದ್ರಾನಗರ", "ಟಿಬಿ ವಂಕೆ", "ಮಂಚನಬಲೆ ರಸ್ತೆ"],
    officers: [
      {
        name: "Sri Lokesh",
        kannadaName: "ಶ್ರೀ ಲೋಕೇಶ್",
        designation: "HC-214",
        kannadaDesignation: "ಹೆಚ್.ಸಿ-214",
        phone: "9902528477",
      },
      {
        name: "Smt. Geetha",
        kannadaName: "ಶ್ರೀಮತಿ ಗೀತಾ",
        designation: "WPSC-328",
        kannadaDesignation: "ಮಪಿಸಿ 328",
        phone: "9535120147",
      },
    ],
    supervisor: {
...
export default function ChikkaballapuraTown() {
  ...
  return (
    <BeatPoliceLayout 
      ...
      talukName={{
        en: "Chikkaballapura Town",
        kn: "ಚಿಕ್ಕಬಳ್ಳಾಪುರ ಪಟ್ಟಣ"
      }}
    />
  );
} 